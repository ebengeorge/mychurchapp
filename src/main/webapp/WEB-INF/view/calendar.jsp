...
<head>
  ...
  <title>Ministry Web | Calendar</title>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="/cms/plugins/fullcalendar/main.css">
  <!-- Theme style -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card-body" id="eventForm">
          <div class="btn-group" style="width: 100%; margin-bottom: 10px;">
      ...
      <div class="modal-footer" id="update-event">
...
<!-- jQuery UI -->
<script src="/cms/plugins/jquery-ui/jquery-ui.min.js"></script>
<!-- AdminLTE App -->
<script src="/cms/dist/js/adminlte.min.js"></script>
<!-- fullCalendar 2.2.5 -->
<script src="/cms/plugins/moment/moment.min.js"></script>
<script src="/cms/plugins/fullcalendar/main.js"></script>
...
// Function to load events (via AJAX)
    function loadEvents() {
      ...
      $.ajax({
        url: '/cms/api/event/calendar',  // Replace with your actual URL to fetch events
        method: 'POST',
        dataType: 'json',
...
// Color chooser button
    ...
    $('#add-new-event').on('click', function() {
      ...
      $.ajax({
        url: "/cms/api/event/save", // Use the form's action URL
        type: "POST",
...
// Delete the event
    $('#delete-event-btn').click(function() {
      ...
      $.ajax({
        url: '/cms/api/event/' + eventId,  // Adjust URL for delete API
        method: 'DELETE',
        success: function(response) {
